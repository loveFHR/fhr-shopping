<template>
    ...
    <el-table :data="list" style="width: 100%">
        ...
        <el-table-column label="操作" align="center" width="280" #default="scope">
            ...
            <el-button type="danger" size="small" @click="deleteSysuser(scope.row)">
                删除
            </el-button>
        ...
        <el-form label-width="120px">
            ...
            <el-form-item label="头像">
                <el-upload
                    ...
                    action="http://127.0.0.1:8501/admin/system/fileUpload"
...
import {GetSysUserListByPage,SaveSysUser,
    UpdateSysUser,DeleteSysUserById,
    DoAssignRoleToUser} from '@/api/sysUser'
...
const fetchData = async () => {
    ...
    const {data} = await GetSysUserListByPage(pageParam.value.page,pageParam.value.limit,queryDto.value)
...
const submit = async () => { //添加或修改(每页id是添加)
    if (!sysUser.value.id){
